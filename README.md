...
workflow described in [docs/PCR_VERIFICATION.md](docs/PCR_VERIFICATION.md).
...
The Nitro EIF jobs use a GitHub-hosted ARM64 larger runner:

- Label: `ubuntu-22.04-arm64-4core`
- Architecture: ARM64
- Resources: 4 CPU cores

Despite the historical label, GitHub currently provisions this as an
ephemeral Hosted Compute Agent using its official ARM runner image. Release
verification rejects attestations generated by self-hosted signing runners.
